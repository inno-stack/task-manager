  ...
  const handleAddTodo = async (todoData: TodoFormData) => {
    try {
      ...
      if (error instanceof Error) {
        ...
        console.error("❌ Unknown error creating todo:", error);
      }
    }
  };
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          {user && (
            <button
              onClick={signOut}
              className="px-4 py-2 bg-blue-600 hover:bg-blue-700 transition-colors duration-200 rounded-lg text-white shadow-sm"
            >
              Logout
            </button>
          )}
